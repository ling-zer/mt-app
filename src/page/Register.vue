...
export default {
  ...
  methods: {
    ...
    input() {
        ...
        var regNum = /(\d)+/g;
        var regCha = /_/g;
        var strength = this.registerForm.password.match(regStr) && this.registerForm.password.match(regNum) && this.registerForm.password.match(regCha);
        
        if(this.registerForm.password.length > 20 || (this.registerForm.password.length > 12 && strength)){
